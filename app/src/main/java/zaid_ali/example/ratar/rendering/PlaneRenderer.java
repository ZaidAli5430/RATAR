...
public class PlaneRenderer {
    ...
    public void createOnGlThread(Context context, String gridDistanceTextureName) throws IOException {
        int vertexShader =
                zaid_ali.example.ratar.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, R.raw.plane_vertex);
        int passthroughShader =
                zaid_ali.example.ratar.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, R.raw.plane_fragment);
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "Program creation");
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "Texture loading");
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "Program parameters");
    }
    ...
    private void draw(float[] cameraView, float[] cameraPerspective) {
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "Drawing plane");
    }
    ...
    public void drawPlanes(Collection<Plane> allPlanes, Pose cameraPose, float[] cameraPerspective) {
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "Setting up to draw planes");
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "Cleaning up after drawing planes");
    }
