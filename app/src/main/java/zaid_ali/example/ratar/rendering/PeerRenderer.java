...
import zaid_ali.example.ratar.Peer;
...
public class PeerRenderer {
    ...
    public void draw(float[] cameraView, float[] cameraPerspective, Peer peer) {
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "upload remote peer data");
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "After draw");
    }
