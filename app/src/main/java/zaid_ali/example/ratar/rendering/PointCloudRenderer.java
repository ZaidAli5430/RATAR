package zaid_ali.example.ratar.rendering;
...
public class PointCloudRenderer {
    ...
    public void createOnGlThread(Context context) {
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "before create");
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "buffer alloc");

        int vertexShader = zaid_ali.example.ratar.rendering.ShaderUtil.loadGLShader(TAG, context,
                GLES20.GL_VERTEX_SHADER, R.raw.point_cloud_vertex);
        int passthroughShader = zaid_ali.example.ratar.rendering.ShaderUtil.loadGLShader(TAG, context,
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "program");
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "program  params");
    }
    ...
    public void update(PointCloud cloud) {
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "before update");
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "after update");
    }
    ...
    public void draw(float[] cameraView, float[] cameraPerspective) {
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "Before draw");
        ...
        zaid_ali.example.ratar.rendering.ShaderUtil.checkGLError(TAG, "Draw");
    }
}
